...
async def handler(event):
    ...
    if "-" not in str(sender.id):
        ...
        if message=='✏️ Editar Grupos':
            keyboard = [Button.inline('✏️ Editar Grupos', data=b'more_time')]
            groups=""
