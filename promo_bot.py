    ...
    try:
        ...
        for archivo in archivos_session:
            try:
                ...
                if userx.is_user_authorized:
                    print('')
                    #accounts_conected[f'{str(id)}_sch']=user
...
async def resend_time_(event):
    ...
    if len(comand)==2:
        ...
        if time_/60>=60 or time_==0 or time_/60==1:   
